...
On the core corpus, with no external compressor for either: Base85N 1.00698,
this format 0.37432 — and encoding is a tie, 1.039 against 1.064 as a ratio of
Base64's time where either spread is larger than the gap. At level −5 it is
0.52273 at 0.786 against Base85N's 0.977 — half the size and faster
